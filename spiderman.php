  ...
  <body>
        ...
        <div class="row align-items-md-stretch mt-4">
          ...
          <div class="col-md-12">
            <div class="h-100 p-5 bg-light border rounded-3">
              ...
              The numbers generated by the python script open doors to some stastic methods, whose results can then be visualized using <a href="http://chartjs.org/">chart.js</a>.
            </div>
          </div>
        </div>
    ...
    <script>
      ...
      for (let i=1; i<=4; i++) {
          ...
          const text = `Propabilites by ${ordinal[i]} Octet of Ipv4 Address`;
          new Chart(ctx, {
              type: 'line',
              data: {
                  datasets: [{
